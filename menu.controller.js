...
exports.addMenu = async(request, response) => {
    try {
        ...
        uploadMenu(request, response, async(error) => {
            ...
            // slipping filename inrequest.body
...
// create and exports func to get all menu
exports.getMenu = async(request, response) => {
    try {
        // gett all menu using model
...
// create and exports func to update menu
...
// create and esports func to delete menu
